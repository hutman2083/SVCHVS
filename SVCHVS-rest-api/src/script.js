...
const apiKey = "Q9bpkCDycCYWCsLdvvrlMy9x8lS02PaWmZ1u7EUrKbY";
...
async function searchUnsplash(searchQuery) {
  const endpoint = `https://api.unsplash.com/search/photos?query=${searchQuery}&per_page=12&page=${currentPage}&client_id=${apiKey}`;
